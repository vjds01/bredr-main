...
class AdoptionInterviewScreen extends StatefulWidget {
  ...
  const AdoptionInterviewScreen({
    super.key,
    required PetListingData this.petData,
  }) : initialQuestions = null,
       editMode = false;

  const AdoptionInterviewScreen.edit({
    super.key,
    required List<Map<String, dynamic>> this.initialQuestions,
  }) : petData = null,
       editMode = true;
...
class _AdoptionInterviewScreenState extends State<AdoptionInterviewScreen> {
  ...
  void initState() {
    super.initState();
    if (widget.editMode) {
      _questions.addAll(widget.initialQuestions!.map(_fromMapQuestion));
    } else {
      _questions.addAll(
  ...
  void _editQuestion(int index) {
    ...
    showModalBottomSheet(
      ...
      builder: (_) => _QuestionEditorSheet(
        ...
        onSave: (updated) {
          setState(
            () => _questions[index] = InterviewQuestion(
  ...
  Future<void> _openStandardLibrary() async {
    final selected = await Navigator.push<List<InterviewQuestion>>(
      context,
      MaterialPageRoute(builder: (_) => const _StandardQuestionsLibrary()),
    );
    ...
    final questions = _questions
        ...
        .map(
          (entry) => PetInterviewQuestion(
            questionId: entry.value.questionId.trim().isEmpty
                ? 'question_${entry.key}'
  ...
  InterviewQuestion _fromMapQuestion(Map<String, dynamic> question) {
    return InterviewQuestion(
      questionId: (question['questionId'] ?? question['id'] ?? '').toString(),
      type: _questionTypeFromLabel((question['type'] ?? '').toString()),
      text: (question['text'] ?? '').toString(),
      choices: (question['choices'] as List? ?? const [])
  ...
  List<Map<String, dynamic>> _questionMaps() =>
      _petQuestions().map((question) => question.toMap()).toList();
  ...
  void _goNext() {
    if (widget.editMode) {
      Navigator.pop(context, _questionMaps());
      return;
    }
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => PetHealthRecordScreen(petData: updatedData),
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 6),
          const Text(
            'How should the adopter answer this question?',
          ...
          GridView.count(
            ...
            children: [
              _TypeCard(
                ...
                onTap: () =>
                    setState(() => _selected = QuestionType.multipleChoice),
              ),
              _TypeCard(
                ...
                onTap: () =>
                    setState(() => _selected = QuestionType.textAnswer),
              ),
              _TypeCard(
                        ...
                        child: Row(
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Icon(Icons.close, color: _color, size: 22),
                            ),
                          ],
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: const [
                            ...
                            Text(
                              'Cannot submit without answering',
                              style: TextStyle(
                                fontSize: 11,
...
class _StandardQuestionsLibraryState extends State<_StandardQuestionsLibrary> {
  String _filter = 'All';
          ...
          children: [
            ...
            Padding(
              ...
              child: TextButton.icon(
                ...
                label: const Text(
                  'Back to Set Adoption Interview Questions',
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: const Color(0xFF5399F0).withValues(alpha: 0.4),
                      ),
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  const SizedBox(height: 16),
                  Text(
                    '${_standardQuestions.length} questions',
                    style: const TextStyle(
                      fontSize: 12,
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    'View Selected  ${_selectedQuestionIds.length}',
                    style: const TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
                    ),
...
class _QuestionMetaChip extends StatelessWidget {
  ...
  const _QuestionMetaChip({required this.label, required this.color});
...
const List<_StandardQuestion> _standardQuestions = [
  ...
  _StandardQuestion(
    ...
    helperText: 'If yes, do they all agree and support having a pet at home?',
  ),
  _StandardQuestion(
    id: 3,
    category: 'Intention',
    type: QuestionType.textAnswer,
    text: 'In your own words, why do you want to adopt a pet at this time?',
    helperText:
  ...
  _StandardQuestion(
    ...
    helperText: 'Be honest and specific about what happened and what changed.',
  ),
  _StandardQuestion(
    id: 10,
    category: 'Home',
  ...
  _StandardQuestion(
    ...
    helperText: 'If yes, how often would you be willing to provide updates?',
  ),
  _StandardQuestion(
    id: 19,
    category: 'Lifestyle',
