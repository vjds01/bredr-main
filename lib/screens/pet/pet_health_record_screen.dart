...
class PetHealthRecordScreen extends StatefulWidget {
  ...
  const PetHealthRecordScreen({super.key, required this.petData});
...
class _PetHealthRecordScreenState extends State<PetHealthRecordScreen> {
  ...
  void _goNext() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => PetReviewScreen(petData: updatedData)),
    );
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Icon(Icons.description_outlined, size: 20, color: _green),
              ],
            ),
          ),
          const SizedBox(width: 12),
...
class _AddHealthRecordSheet extends StatefulWidget {
  ...
  const _AddHealthRecordSheet({required this.onSave, this.initialRecord});
...
class _HealthRecordPreviewDialog extends StatelessWidget {
  ...
  const _HealthRecordPreviewDialog({required this.record});
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _BlueTextField(
                        ...
                        controller: _vetCtrl,
                        errorText:
                            _validationAttempted && _vetCtrl.text.trim().isEmpty
                ...
                child: Container(
                  ...
                  child: Center(
                    child: _VerifyDialog(
                      ...
                      onCancel: () => setState(() => _showVerifyDialog = false),
                    ),
                  ),
                ),
              ),
...
class _HealthValidationNotice extends StatelessWidget {
  const _HealthValidationNotice();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(
        children: [
          Icon(Icons.error_outline, color: Color(0xFFE04455), size: 19),
          SizedBox(width: 8),
          Expanded(
            child: Text(
...
class _UploadFileArea extends StatelessWidget {
  ...
  const _UploadFileArea({required this.onUpload, required this.onCamera});
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.search, color: _blue, size: 20),
